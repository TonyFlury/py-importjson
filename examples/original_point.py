"""Module original_point - Created by JSONLoader v0.0.1a3 
   Original json data : original_point.json
   Generated Mon 19 Oct 2015 09:57:02 BST (UTC +0100)"""
__version__ = u'0.1'
...
class point (object):
    ...
    @property
    def x(self):
        """set/get x attribute - allows for <original_point.point>.x = <value>"""
        return self._x
    ...
    @property
    def y(self):
        """set/get y attribute - allows for <original_point.point>.y = <value>"""
        return self._y
    ...
    @property
    def colour(self):
        """set/get colour attribute - allows for <original_point.point>.colour = <value>"""
        return self._colour
